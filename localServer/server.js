...
/**
 * https://instagram.com/oauth/authorize/?client_id=953d8c6c266a4c0b98c5d6f06f3898b2&redirect_uri=http://localhost:8000&response_type=code
 * https://instagram.com/oauth/authorize/?client_id=953d8c6c266a4c0b98c5d6f06f3898b2&redirect_uri=http://localhost:8000&response_type=token
 *
...
HttpServer.prototype.handleRequest_ = function(req, res) {
  ...
  req.url = this.parseUrl_(req.url);
   ...
   var defaultHandler = (function(context, req, res){
    return function(){
        var handler = context.handlers[req.method];
        if (!handler) {
          res.writeHead(501);
          res.end();
        } else {
  ...
  router.route(req, res, defaultHandler);
